...
locals {
  ...
  lb_name        = var.load_balancer.vpc_name_abr != "${var.common.account_name_abr}-${var.load_balancer.vpc_name_abr}-${var.common.region_prefix}-${var.load_balancer.name}-${local.lb_type_suffix}"
}
